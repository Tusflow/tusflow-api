...
interface AuthConfig {
    excludePaths?: string[];
    onError?: (c: Context, err: { code: "INTERNAL_SERVER_ERROR"; docs: string; message: string; requestId: string; }) => Response | Promise<Response>;
...
function defaultErrorHandler(
    c: Context,
    err: { code: "INTERNAL_SERVER_ERROR"; docs: string; message: string; requestId: string; }
): Response {
